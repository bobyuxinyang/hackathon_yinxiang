...
@interface MainViewController : UIViewController <MusicSelectedDeleagate, MusicPlayerDeleagate, UIAlertViewDelegate, UITableViewDataSource, UITableViewDelegate>
