...
#define YX_XMPP_SERVER_CONNECTED @"YX_XMPP_SERVER_CONNECTED"
#define YX_BUMP_SERVER_CONNECTED @"YX_BUMP_SERVER_CONNECTED"
#define YX_BUMP_SERVER_DISCONNECTED @"YX_BUMP_SERVER_DISCONNECTED"
